 ...
 */
final class Version20230222092312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, order_detail_id INT NOT NULL, title VARCHAR(100) NOT NULL, introduction VARCHAR(255) NOT NULL, description TEXT NOT NULL, published_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, slug VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, language VARCHAR(20) NOT NULL, nb_pages INT NOT NULL, size VARCHAR(20) NOT NULL, isbn VARCHAR(50) NOT NULL, editor VARCHAR(50) NOT NULL, is_in_stock BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_CBE5A33164577843 ON book (order_detail_id)');
        ...
        $this->addSql('CREATE TABLE order_detail (id INT NOT NULL, quantity INT NOT NULL, price DOUBLE PRECISION NOT NULL, total DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(45) NOT NULL, first_name VARCHAR(45) NOT NULL, last_name VARCHAR(45) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_verified BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE address ADD CONSTRAINT FK_D4E6F818012C5B0 FOREIGN KEY (resident_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A33164577843 FOREIGN KEY (order_detail_id) REFERENCES order_detail (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE address DROP CONSTRAINT FK_D4E6F818012C5B0');
        ...
        $this->addSql('ALTER TABLE book DROP CONSTRAINT FK_CBE5A33164577843');
